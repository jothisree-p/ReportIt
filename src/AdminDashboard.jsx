            ...
            <div className="dashboard-box">
              ...
              <div className="complaint-item">
                <div className="left-complaint">
                  ...
                  <div>
                    <h4>Bike Theft at Market Area</h4>
                    <p>CMP-2024-001 · Rahul Sharma</p>
                  </div>
                </div>
              ...
              <div className="complaint-item">
                <div className="left-complaint">
                  <div className="complaint-icon"><FaFileAlt /></div>
                  <div>
                    <h4>Property Wall Damaged</h4>
                    <p>CMP-2024-003 · Amit Kumar</p>
                  </div>
                </div>
              ...
              <div className="complaint-item">
                <div className="left-complaint">
                  <div className="complaint-icon"><FaFileAlt /></div>
                  <div>
                    <h4>Road Accident Near Highway</h4>
                    <p>CMP-2024-004 · Sneha Reddy</p>
                  </div>
                </div>
                <span className="resolved-text">Resolved</span>
              </div>
